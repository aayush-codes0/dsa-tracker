...
import { sheets as sheetsApi, problems as problemsApi } from '../api/api';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link to="/sheets" className="p-2 hover:bg-slate-800 rounded-lg text-slate-400 hover:text-white transition-colors">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-1">{sheet.description}</p>
        </div>
      </div>
